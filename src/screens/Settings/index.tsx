...
const Settings = () => {
  ...
  const [DayTimePercentage, setDayTimePercentage] = useState(
    CalcParams.DayTimePercentage.toString()
  );
  const [NightTimePercentage, setNightTimePercentage] = useState(
    CalcParams.NightTimePercentage.toString()
  );
  const [SundaysTimePercentage, setSundayTimePercentage] = useState(
    CalcParams.SundaysTimePercentage.toString()
  );
  ...
  return (
    <SafeAreaView style={styles.MainContainer}>
      ...
      />
      <CustomInput
        title={"Extra daytime percentage"}
        defaultValue={DayTimePercentage}
        onChangeText={setDayTimePercentage}
      />
      <CustomInput
        title={"Extra night percentage"}
        defaultValue={NightTimePercentage}
        onChangeText={setNightTimePercentage}
      />
      <CustomInput
        title={"Extra percentage on Sundays and holidays"}
        defaultValue={SundaysTimePercentage}
        onChangeText={setSundayTimePercentage}
      />
